                    ...
                    <Grid container spacing={1}>
                        <Grid item>
                            <ButtonBase className={classes.image}>
                                <Typography style={{ backgroundColor: '#228B22', textAlign: 'center', borderRadius: '10px 10px 70px 70px ', width: '400px' }}>
                            ...
                            <Typography variant="body2" color="textSecondary">
                                <Button onClick={() => alert('Button Clicked')} style={{
                                    ...
                                    cursor: 'pointer', marginTop: '135px'
                                }}>stake now</Button>
                            </Typography>
                        </Grid>
                    </Grid>
                        ...
                        <Grid item>
                            ...
                            <Typography variant="body2">
                                <Button onClick={() => alert('Button Clicked')} style={{
                                    ...
                                    fontSize: '15px', cursor: 'pointer', marginTop: '85px', overflow:'hidden', position:'initial'
                                }}>stake now</Button>
                            </Typography>
                        </Grid>
                    </Grid>
